      ...
      <section className="px-6 md:px-12 pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-md p-5">
            ...
            <a
              href="https://wa.me/918580928154?text=Hello%2C%20I%20want%20to%20order%20Granny%20Smith%20apples"
              target="_blank"
          ...
          <div className="bg-white rounded-2xl shadow-md p-5">
            ...
            <a
              href="https://wa.me/918580928154?text=Hello%2C%20I%20want%20to%20order%20Gala%20apples"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 w-full bg-green-600 text-white py-3 rounded-xl flex items-center justify-center"
            >
          ...
          <div className="bg-white rounded-2xl shadow-md p-5">
            ...
            <a
              href="https://wa.me/918580928154?text=Hello%2C%20I%20want%20to%20order%20Royal%20apples"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 w-full bg-green-600 text-white py-3 rounded-xl flex items-center justify-center"
            >
